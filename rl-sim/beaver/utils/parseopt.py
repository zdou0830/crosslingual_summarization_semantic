...
def data_opts(parser):
    ...
    parser.add_argument("-en_vecs", type=str, help="Training vec data")
...
def train_opts(parser):
    ...
    parser.add_argument("-max_train_step", type=int, default=1000000, help="Report every n steps")
    ...
    parser.add_argument("-beta", type=float, default=0.0, help="Alpha")

    parser.add_argument("-train_from", type=str, default=None, help="Train from checkpoint")
    parser.add_argument("-sim_model_file", type=str, default=None, help="Train from checkpoint")
