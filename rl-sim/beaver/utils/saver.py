...
class Saver(object):
    ...
    def save(self, save_dict, step, loss_task1, loss_task2, bleu_task1, bleu_task2, rouge1_task1, rouge1_task2, rouge2_task1, rouge2_task2, rougeL_task1, rougeL_task2):
        ...
        with open(os.path.join(self.model_path, "log"), "a", encoding="UTF-8") as log:
            ...
            log.write("rouge2-task1: %3.2f\t" % rougeL_task1)
            log.write("rouge2-task2: %3.2f\t" % rougeL_task2)
            log.write("\n")
